...
public interface INavigationService
{
    ...
    ///     <para/>
    ///     It is used for navigation, primarily to determine which page is currently being displayed.
    ...
    ///     It is used to set an explicit view model of the new current page at the time of navigation.
    ///     In other words, this property provides a tool to pass an explicit view model data to the new page.
    /// </summary>
    /// <remarks>
    ...
    /// </summary>
    /// <param name="pageIdentifier">The page identifier (<see cref="IPageViewModel.PageIdentifier"/>) specifying the target page to navigate to.</param>
